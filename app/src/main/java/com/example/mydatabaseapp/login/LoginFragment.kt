...
class LoginFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        loginViewModel.errotoast.observe(this, Observer { hasError->
            if(hasError==true){
                Toast.makeText(requireContext(), "Por favor llena todos los espacios", Toast.LENGTH_SHORT).show()
        ...
        loginViewModel.errotoastUsername .observe(this, Observer { hasError->
            if(hasError==true){
                Toast.makeText(requireContext(), "La usuario no existe, por favor regístrate!", Toast.LENGTH_SHORT).show()
        ...
        loginViewModel.errorToastInvalidPassword.observe(this, Observer { hasError->
            if(hasError==true){
                Toast.makeText(requireContext(), "Por favor revise su contraseña", Toast.LENGTH_SHORT).show()
